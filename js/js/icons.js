...
// ==================================================================
// Module: Icônes SVG pour l'interface utilisateur
// Dépendances: Aucune
// Utilisé par: Tous les modules de vue (app.js, terrain.js, missions.js, etc.)
// Description: Collection centralisée d'icônes SVG au format Feather Icons
// © 2025 Quentin THOMAS
// ==================================================================

/**
 * Bibliothèque d'icônes SVG
 * Toutes les icônes sont au format SVG inline pour une intégration facile
 * Style: Feather Icons - stroke-width: 2, viewBox: 0 0 24 24
 */
const ICONS = {
  // ==== Navigation & Actions ====
...
/**
 * Obtient une icône par son nom
 * @param {string} name - Nom de l'icône
 * @returns {string} SVG de l'icône ou icône vide si non trouvée
 */
...
console.log('✓ Module ICONS chargé');
console.log(`  → ${Object.keys(ICONS).length} icônes disponibles`);
console.log('  → Catégories: Navigation, Actions, VLEP, Données, Mesures, Utilisateurs, Temps, Import/Export, Audio');
