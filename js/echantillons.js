...
function renderConditions(){
  ...
  if(m.conditionsAmbiantes.length===0)h+='<div class="empty-state"><p>Aucune condition saisie</p></div>';
    ...
    // Température
    h+='<div class="condition-row"><span class="condition-label">'+ICONS.thermometer+' Température (°C)</span><div class="condition-inputs"><div style="flex:1;"><div class="condition-input-label">Initial</div><input type="text" readonly class="condition-input condition-input-i kp-field" value="'+(c.tempI||'')+'" placeholder="I" onclick="openKeypad('+(c.tempI||'')+',(function(ci){return function(v){updateCond(ci,\'tempI\',v);render();}})('+ i +'),true);"></div><div style="flex:1;"><div class="condition-input-label">Final</div><input type="text" readonly class="condition-input condition-input-f kp-field" value="'+(c.tempF||'')+'" placeholder="F" onclick="openKeypad('+(c.tempF||'')+',(function(ci){return function(v){updateCond(ci,\'tempF\',v);render();}})('+ i +'),true);"></div></div></div>';
    
    // Pression
    h+='<div class="condition-row"><span class="condition-label">'+ICONS.database+' Pression (hPa)</span><div class="condition-inputs"><div style="flex:1;"><div class="condition-input-label">Initial</div><input type="text" readonly class="condition-input condition-input-i kp-field" value="'+(c.pressionI||'')+'" placeholder="I" onclick="openKeypad('+(c.pressionI||'')+',(function(ci){return function(v){updateCond(ci,\'pressionI\',v);render();}})('+ i +'),false);"></div><div style="flex:1;"><div class="condition-input-label">Final</div><input type="text" readonly class="condition-input condition-input-f kp-field" value="'+(c.pressionF||'')+'" placeholder="F" onclick="openKeypad('+(c.pressionF||'')+',(function(ci){return function(v){updateCond(ci,\'pressionF\',v);render();}})('+ i +'),false);"></div></div></div>';
    
    // Humidité
    h+='<div class="condition-row"><span class="condition-label">'+ICONS.droplet+' Humidité (%)</span><div class="condition-inputs"><div style="flex:1;"><div class="condition-input-label">Initial</div><input type="text" readonly class="condition-input condition-input-i kp-field" value="'+(c.humiditeI||'')+'" placeholder="I" onclick="openKeypad('+(c.humiditeI||'')+',(function(ci){return function(v){updateCond(ci,\'humiditeI\',v);render();}})('+ i +'),false);"></div><div style="flex:1;"><div class="condition-input-label">Final</div><input type="text" readonly class="condition-input condition-input-f kp-field" value="'+(c.humiditeF||'')+'" placeholder="F" onclick="openKeypad('+(c.humiditeF||'')+',(function(ci){return function(v){updateCond(ci,\'humiditeF\',v);render();}})('+ i +'),false);"></div></div></div>';
